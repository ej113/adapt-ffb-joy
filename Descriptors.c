...
0xA1,0x01,	// COLLECTION (Application)
	...
	// modifed FFW input descriptor:
	//HID_RI_USAGE(8, 0x04), // Pointer
	//HID_RI_COLLECTION(8, 0x00), // Physical

		0x05, 0x02,                    //   USAGE_PAGE (Simulation Controls)

		HID_RI_USAGE(8, 0xc8), // Usage Steering
		HID_RI_LOGICAL_MINIMUM(16, 0),
		HID_RI_LOGICAL_MAXIMUM(16, 1023),
		HID_RI_PHYSICAL_MINIMUM(8, -512),
		HID_RI_PHYSICAL_MAXIMUM(16, 511),
		HID_RI_REPORT_COUNT(8, 0x01),
		HID_RI_REPORT_SIZE(8, 0x10),
		HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),

		HID_RI_USAGE(8, 0xc4), // Usage Accellerator
		HID_RI_LOGICAL_MINIMUM(16, 0),
		HID_RI_LOGICAL_MAXIMUM(16, 1023),
		HID_RI_PHYSICAL_MINIMUM(8, 0),
		HID_RI_PHYSICAL_MAXIMUM(16, 1023),
		...
		HID_RI_REPORT_SIZE(8, 0x06),
		HID_RI_REPORT_COUNT(8, 0x01),
		HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),		 // Brake
		...
		HID_RI_USAGE_PAGE(8, 0x09),    // USAGE (Button)
		HID_RI_USAGE_MINIMUM(8, 0x01),
		...
		HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),  //Button 1 to 9

		0x75, 0x07,		//     REPORT_SIZE (2)
		0x95, 0x01,		//     REPORT_COUNT (1)
		0x81, 0x01,		//     INPUT (Cnst,Ary,Abs)		 7b Fill*/
		...
		HID_RI_REPORT_SIZE(8, 0x01),
		HID_RI_REPORT_COUNT(8, 0x08),
		HID_RI_INPUT(8, HID_IOF_DATA | HID_IOF_VARIABLE | HID_IOF_ABSOLUTE),*/ //Button 9 to 16
	...
	.HID_JoystickHID =
		{
			...
			.TotalReportDescriptors = 1,
			.HIDReportType = HID_DTYPE_Report,
			.HIDReportLength = sizeof(WheelReport)
		},
